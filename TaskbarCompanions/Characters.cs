...
public sealed record CharacterDefinition(string Id, string Name, string Role, string Accent,
    Action<DrawingContext, CharacterFrame> Draw, string[] Dialogue, bool Grounded = false);
...
{
    // Listed in home order, from the right end of the taskbar; hidden companions leave no gap.
    public static readonly CharacterDefinition[] All =
    {
        ...
        CodexCompanion.Frames is not null
            ? new("codex", "CODEX", "Codex pet", "#8EF0CF", CodexCompanion.Draw,
                ...
                Grounded: true)
            : new("codex", "CODEX", "little terminal explorer", "#8EF0CF", TerminalExplorer.Draw,
        ...
        new("claude", "CLAUDE", "pixel critter · thinks things through", "#D77757", Clawd.Draw,
